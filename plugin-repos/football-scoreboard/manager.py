...
class FootballScoreboardPlugin(BasePlugin if BasePlugin else object):
    ...
    def get_live_games(self) -> List[Dict[str, Any]]:
        """Return all currently live games across NFL and NCAA FB.
    ...
    def get_game_focus_data(self, game_id: str) -> Optional[Dict[str, Any]]:
        ...
        focus_data: Dict[str, Any] = {
            ...
            "away_color": get_team_color(game.get("away_abbr", ""), league or "nfl") if get_team_color else COLOR_WHITE,
            "home_color": get_team_color(game.get("home_abbr", ""), league or "nfl") if get_team_color else COLOR_WHITE,
            "away_score": int(game.get("away_score", 0)),
            "home_score": int(game.get("home_score", 0)),
            "status_state": status_state,
            "game_clock": game.get("clock", ""),
            "period_label": game.get("period_text", ""),
    ...
    def _load_game_logo(self, game: Dict, side: str) -> Optional[Image.Image]:
        ...
        try:
            ...
            league = self._get_league_for_game(str(game.get("id", ""))) or "nfl"
