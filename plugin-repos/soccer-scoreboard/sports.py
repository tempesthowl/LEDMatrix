        ...
        try:
            ...
            if start_time_utc:
                ...
                if use_short_date_format:
                    # Portable no-pad m/d. strftime("%-m/%-d") is glibc-only and
                    # raises "Invalid format string" on Windows (emulator), which
                    # silently drops the event in _extract_game_details_common.
