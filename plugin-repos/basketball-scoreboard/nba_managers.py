...
class BaseNBAManager(Basketball):
    ...
    def _fetch_data(self) -> Optional[Dict]:
        ...
        if isinstance(self, NBALiveManager):
            ...
            # Use focused recent-window query (3 weeks) instead of full season
            # cache, which caps at 1000 events and truncates recent games.
            weeks_data = self._get_weeks_data()
            if weeks_data:
                return weeks_data
            # Fall back to season cache if weeks query fails
